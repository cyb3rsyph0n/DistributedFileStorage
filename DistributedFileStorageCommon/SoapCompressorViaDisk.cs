...
namespace DistributedFileStorageCommon
{
    ...
    /// </summary>
    public class SoapCompressorViaDisk : SoapExtension
    {
        ...
        public override System.IO.Stream ChainStream(System.IO.Stream stream)
        {
            ...
            newStream = new TempFileStream(Path.GetTempFileName(), FileMode.OpenOrCreate, FileAccess.ReadWrite, FileShare.ReadWrite);
            return newStream;
        }
...
public class SoapCompressorViaDiskAttribute : SoapExtensionAttribute
{
    public override Type ExtensionType
    {
        get { return typeof(DistributedFileStorageCommon.SoapCompressorViaDisk); }
    }
