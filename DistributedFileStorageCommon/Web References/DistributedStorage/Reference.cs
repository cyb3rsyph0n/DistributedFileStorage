...
namespace DistributedFileStorageCommon.DistributedStorage {
    using System;
    ...
    public partial class DistributedStorage : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public DistributedStorage() {
            this.Url = global::DistributedFileStorageCommon.Properties.Settings.Default.DistributedFileStorageCommon_DistributedStorage_DistributedStorage;
        ...
        public void DeleteFileAsync(string folder, string fileName) {
            this.DeleteFileAsync(folder, fileName, null);
        }
        
        /// <remarks/>
        public void DeleteFileAsync(string folder, string fileName, object userState) {
